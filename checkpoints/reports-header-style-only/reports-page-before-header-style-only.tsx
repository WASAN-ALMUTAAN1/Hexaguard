...
function Header({
  ...
  return (
    <>
      <header className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/75 px-8 py-14 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
        <div className="pointer-events-none absolute inset-0 opacity-[0.16] [background-image:linear-gradient(rgba(255,255,255,0.11)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.11)_1px,transparent_1px)] [background-size:46px_46px]" />
        <div className="pointer-events-none absolute -left-28 top-0 h-72 w-72 rounded-full bg-red-500/18 blur-3xl" />
        <div className="pointer-events-none absolute -right-28 top-10 h-72 w-72 rounded-full bg-cyan-500/10 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-5 text-4xl font-black uppercase leading-[0.95] tracking-[-0.055em] text-white md:text-6xl">
            AI Red Teaming
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <span className="rounded-full border border-emerald-400/20 bg-emerald-500/10 px-5 py-2 text-sm font-black text-emerald-300">
              1. Test Results
            </span>

            <span className="rounded-full border border-cyan-400/20 bg-cyan-500/10 px-5 py-2 text-sm font-black text-cyan-300">
              2. Risk Scores
            </span>

            <span className="rounded-full border border-amber-400/20 bg-amber-500/10 px-5 py-2 text-sm font-black text-amber-300">
              3. Model Comparison
            </span>

            <span className="rounded-full border border-red-400/20 bg-red-500/10 px-5 py-2 text-sm font-black text-red-300">
              4. Recommendations
            </span>
          </div>
        </div>
      ...
      <section className="relative mx-auto mt-6 max-w-[1320px] overflow-hidden rounded-[24px] border border-white/10 bg-[#202323]/75 p-4 shadow-[0_18px_55px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
        ...
        <div className="relative grid gap-3 lg:grid-cols-[1fr_auto]">
          <input
            ...
            placeholder="HXG-CMP-..."
            className="h-12 rounded-2xl border border-white/10 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/50"
          />

          <button
            onClick={onLoad ?? noop}
            className="h-12 rounded-2xl bg-red-500 px-8 text-sm font-black text-white shadow-[0_0_24px_rgba(239,68,68,0.25)] transition hover:bg-red-400"
          >
            Load Report
          </button>
        </div>
