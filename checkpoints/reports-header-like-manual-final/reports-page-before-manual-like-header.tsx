    ...
    <header className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/75 px-8 py-14 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <span className="rounded-full border border-cyan-400/20 bg-cyan-500/10 px-5 py-2 text-sm font-black text-cyan-300 shadow-[0_0_18px_rgba(34,211,238,0.10)]">
            Campaign: <span className="font-mono text-cyan-100">{campaignId || "Not selected"}</span>
          </span>

          <span className="rounded-full border border-emerald-400/20 bg-emerald-500/10 px-5 py-2 text-sm font-black text-emerald-300">
            Status: <span className="font-mono text-emerald-100">{status || "Not loaded"}</span>
          </span>

          <span className="rounded-full border border-amber-400/20 bg-amber-500/10 px-5 py-2 text-sm font-black text-amber-300">
            Readiness: <span className="font-mono text-amber-100">{readiness || "Ready"}</span>
          </span>
        ...
        <div className="mx-auto mt-7 max-w-4xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
