                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            {model.status === "needs_setup" ? (
                              <button
                                ...
                                className="h-9 rounded-[12px] border border-amber-400/25 bg-amber-500/10 px-4 text-xs font-black text-amber-300 transition hover:bg-amber-500/15"
                              >
                                Configure
                              </button>
                            ) : model.status === "disabled" ? (
                              <button
                                ...
                                className="h-9 rounded-[12px] border border-emerald-400/25 bg-emerald-500/10 px-4 text-xs font-black text-emerald-300 transition hover:bg-emerald-500/15"
                              >
                                Enable
                              </button>
                            ) : (
                              ...
                              {openMenuId === model.id ? (
                                <div className="absolute right-0 top-11 z-30 w-48 overflow-hidden rounded-[14px] border border-white/[0.08] bg-[#1f2122] p-1 shadow-[0_18px_50px_rgba(0,0,0,0.45)]">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => {
                                      const confirmed = window.confirm(`Delete ${model.displayName}? This will remove it from the active model registry.`);
