      ...
      {openMenuId && actionMenuPosition ? (() => {
        ...
        return (
          <div
            ...
            className="fixed z-[200] w-48 rounded-[14px] border border-white/[0.08] bg-[#1f2122] p-1 shadow-[0_24px_70px_rgba(0,0,0,0.65)]"
            style={{
          ...
          >
            <button
              ...
              className="block w-full rounded-[10px] bg-transparent px-4 py-3 text-left text-xs font-black text-white transition hover:bg-white/[0.05]"
            >
              Edit
            </button>
            ...
            <button
              ...
              className={`block w-full rounded-[10px] bg-transparent px-4 py-3 text-left text-xs font-black transition ${
            ...
            <button
              ...
              className="block w-full rounded-[10px] bg-transparent px-4 py-3 text-left text-xs font-black text-[#4ad7ff] transition hover:bg-[#4ad7ff]/10"
            >
              Test Connection
            </button>
            ...
            <button
              ...
              className="block w-full rounded-[10px] bg-transparent px-4 py-3 text-left text-xs font-black text-red-300 transition hover:bg-red-500/10"
            >
              Delete Model
            </button>
          </div>
