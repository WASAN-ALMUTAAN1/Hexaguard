...
function Header({
  ...
  return (
    <header className="relative mx-auto w-full max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/74 px-8 py-10 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
      <div className="pointer-events-none absolute inset-0 opacity-[0.12] [background-image:linear-gradient(rgba(255,255,255,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:46px_46px]" />

      <div className="pointer-events-none absolute left-[8%] top-[8%] h-64 w-64 rounded-full bg-red-500/5 blur-[140px]" />
      <div className="pointer-events-none absolute right-[8%] top-[8%] h-64 w-64 rounded-full bg-cyan-500/6 blur-[140px]" />

      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_0%,rgba(239,68,68,0.045),transparent_34%),radial-gradient(circle_at_82%_0%,rgba(34,211,238,0.06),transparent_34%)]" />
