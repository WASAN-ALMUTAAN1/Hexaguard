...
function Header({
  ...
  return (
    <header className="relative mx-auto max-w-[1040px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/78 px-8 py-10 text-center shadow-[0_22px_70px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mx-auto mt-6 max-w-3xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
            <input
              value={campaignIdInput ?? displayCampaignId}
              onChange={(event) => onCampaignIdInputChange?.(event.target.value)}
              placeholder="HXG-CMP-..."
              className="h-11 rounded-2xl border border-red-400/20 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/45"
            />

            <button
              onClick={onLoad ?? noop}
              className="h-11 rounded-2xl bg-red-500 px-7 text-sm font-black text-white shadow-[0_0_22px_rgba(239,68,68,0.22)] transition hover:bg-red-400"
            >
              Load Report
            </button>
          </div>
