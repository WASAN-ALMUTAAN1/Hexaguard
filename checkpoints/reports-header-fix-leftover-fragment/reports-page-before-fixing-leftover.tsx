          ...
          <div className="space-y-6">
            ...
            <Panel title="Export Final Report Package" icon={<FileText className="text-cyan-300" size={18} />}>
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <ActionButton onClick={exportCsv} icon={<Download size={16} />}>Export Spreadsheet Report</ActionButton>
                <ActionButton
                  primary
...
function Header({
  ...
  return (
    <header className="mb-8">
      <div className="relative overflow-hidden rounded-[30px] border border-white/8 bg-[#1f2122]/95 px-6 py-10 shadow-[0_20px_80px_rgba(0,0,0,0.32)] md:px-10 md:py-12">
        {/* subtle background like Manual page */}
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.04)_1px,transparent_1px)] bg-[size:56px_56px] opacity-[0.14]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(239,68,68,0.08)_0%,rgba(31,33,34,0.02)_26%,rgba(34,211,238,0.05)_100%)]" />
        <div className="pointer-events-none absolute -left-16 top-10 h-44 w-44 rounded-full bg-red-500/8 blur-[110px]" />
        <div className="pointer-events-none absolute right-0 top-6 h-52 w-52 rounded-full bg-cyan-400/6 blur-[120px]" />

        <div className="relative mx-auto max-w-5xl text-center">
          <p className="font-mono text-[12px] font-semibold uppercase tracking-[0.38em] text-cyan-400">
            HexaGuard Reports
          </p>

          <h1 className="mt-4 text-[44px] font-black uppercase leading-[0.92] tracking-tight text-white md:text-[64px]">
            AI Risk Analysis
            <span className="mt-2 block text-[#ff4338]">Reports</span>
          </h1>

          <p className="mx-auto mt-5 max-w-4xl text-lg leading-8 text-gray-300 md:text-[17px]">
            Review final campaign evidence, residual risks, model performance,
            recommendations, and export-ready analytical reports.
          </p>

          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            <span className="rounded-full border border-cyan-400/20 bg-cyan-500/10 px-5 py-2 font-mono text-sm text-cyan-300">
              Campaign: <span className="font-semibold text-cyan-200">{currentCampaignId || "Not loaded"}</span>
            </span>

            <span className="rounded-full border border-emerald-400/20 bg-emerald-500/10 px-5 py-2 font-mono text-sm text-emerald-300">
              Status: <span className="font-semibold text-gray-100">{currentStatus}</span>
            </span>

            <span className="rounded-full border border-amber-400/20 bg-amber-500/10 px-5 py-2 font-mono text-sm text-amber-300">
              Readiness: <span className="font-semibold text-gray-100">{currentReadiness}</span>
            </span>

            <span className="rounded-full border border-white/10 bg-white/5 px-5 py-2 font-mono text-sm text-gray-300">
              Manual Evidence: <span className="font-semibold text-gray-100">{manualEvidenceCount ?? 0}</span>
            </span>
          </div>

          <div className="mx-auto mt-8 max-w-5xl rounded-[26px] border border-white/8 bg-[#202326]/88 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:p-5">
            <div className="grid gap-3 md:grid-cols-[1fr_200px]">
              <input
                value={currentCampaignId}
                onChange={(e) => setCampaignId?.(e.target.value)}
                placeholder="Enter campaign ID"
                className="h-14 rounded-[18px] border border-red-500/35 bg-[#1a1c1f] px-5 font-mono text-lg text-gray-200 outline-none transition placeholder:text-gray-500 focus:border-red-400/50"
              />
              ...
              <button
                ...
                onClick={onLoad ?? noop}
                disabled={loading}
                className="h-14 rounded-[18px] bg-[#ff4338] px-6 text-lg font-bold text-white shadow-[0_10px_30px_rgba(255,67,56,0.25)] transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
              >
          ...
          {lastUpdated ? (
            <p className="mt-4 font-mono text-[11px] text-gray-500">
              Last updated: <span className="text-gray-300">{formatDate(lastUpdated)}</span>
            </p>
          ) : null}
        </div>
      </div>
...
: any) {
  ...
  return (
    <header className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/75 px-8 py-12 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
      <div className="pointer-events-none absolute inset-0 opacity-[0.14] [background-image:linear-gradient(rgba(255,255,255,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:46px_46px]" />
      <div className="pointer-events-none absolute -left-20 top-4 h-52 w-52 rounded-full bg-red-500/5 blur-[130px]" />
      <div className="pointer-events-none absolute -right-28 top-10 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_0%,rgba(239,68,68,0.05),transparent_30%),radial-gradient(circle_at_82%_0%,rgba(34,211,238,0.07),transparent_30%)]" />

      <div className="relative mx-auto max-w-5xl">
        <p className="text-[10px] font-black uppercase tracking-[0.48em] text-cyan-300">
          HexaGuard Reports
        </p>

        <h1 className="mt-5 text-4xl font-black uppercase leading-[0.95] tracking-[-0.055em] text-white md:text-5xl">
          AI Risk Analysis
          <span className="mt-1 block text-red-500">Reports</span>
        </h1>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <span className="rounded-full border border-cyan-400/20 bg-cyan-500/10 px-4 py-1.5 text-xs font-black text-cyan-300 shadow-[0_0_18px_rgba(34,211,238,0.07)]">
            Campaign: <span className="font-mono text-cyan-100">{displayCampaignId}</span>
          </span>

          <span className="rounded-full border border-emerald-400/20 bg-emerald-500/10 px-4 py-1.5 text-xs font-black text-emerald-300">
            Status: <span className="font-mono text-emerald-100">{displayStatus}</span>
          </span>

          <span className="rounded-full border border-amber-400/20 bg-amber-500/10 px-4 py-1.5 text-xs font-black text-amber-300">
            Readiness: <span className="font-mono text-amber-100">{displayReadiness}</span>
          </span>

          <span className="rounded-full border border-red-400/20 bg-red-500/10 px-4 py-1.5 text-xs font-black text-red-300">
            Evidence: <span className="font-mono text-red-100">{manualEvidenceCount ?? 0}</span>
          </span>
        </div>

        <div className="mx-auto mt-6 max-w-4xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
            <input
              value={campaignIdInput || ""}
              onChange={(event) => onCampaignIdInputChange?.(event.target.value)}
              placeholder="HXG-CMP-..."
              className="h-11 rounded-2xl border border-white/10 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/50"
            />

            <button
              onClick={onLoad ?? noop}
              className="h-11 rounded-2xl bg-red-500 px-7 text-sm font-black text-white shadow-[0_0_24px_rgba(239,68,68,0.25)] transition hover:bg-red-400"
            >
              Load Report
            </button>
          </div>
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-5">
            <HeaderButton onClick={onRefresh ?? noop} icon={<RefreshCw size={14} />}>
              Sync
            </HeaderButton>

            <HeaderButton onClick={onCopy ?? noop} icon={<Copy size={14} />}>
              Copy
            </HeaderButton>

            <HeaderButton onClick={onJson ?? noop} icon={<FileJson size={14} />}>
              JSON
            </HeaderButton>

            <HeaderButton onClick={onCsv ?? noop} icon={<Download size={14} />}>
              Spreadsheet
            </HeaderButton>

            <HeaderButton onClick={onPdf ?? noop} icon={<FileText size={14} />}>
              PDF
            </HeaderButton>
          </div>
        </div>
...
function RiskBadge({ level, score }: { level: RiskLevel; score: number }) {
  const styles: Record<string, string> = {
    Critical: "border-red-300/40 bg-red-500 text-white shadow-[0_0_18px_rgba(239,68,68,0.38)]",
