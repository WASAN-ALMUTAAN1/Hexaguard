...
<body>
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#080c0f] pb-16 text-gray-300 selection:bg-red-500/10">
...
function Header({
  ...
  return (
    <div className="relative isolate mx-auto w-full max-w-7xl">
      <div className="pointer-events-none absolute -left-8 top-8 -z-10 h-72 w-72 rounded-full bg-red-500/8 blur-[140px]" />
      ...
      <header className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/82 px-8 py-8 text-center shadow-[0_22px_70px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_12%,rgba(239,68,68,0.035),transparent_36%),radial-gradient(circle_at_82%_8%,rgba(34,211,238,0.06),transparent_36%)]" />
...
function RiskBadge({ level, score }: { level: RiskLevel; score: number }) {
  const styles: Record<string, string> = {
    Critical: "border-red-300/40 bg-red-500 text-white shadow-[0_0_18px_rgba(239,68,68,0.10)]",
