...
function Header({
  ...
  return (
    <header className="relative mx-auto w-full max-w-7xl overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/78 px-8 py-8 text-center shadow-[0_22px_70px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
      ...
      <div className="pointer-events-none absolute left-6 top-10 h-48 w-48 rounded-full bg-red-500/5 blur-[130px]" />
      <div className="pointer-events-none absolute right-4 top-6 h-56 w-56 rounded-full bg-cyan-500/7 blur-[130px]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_12%,rgba(239,68,68,0.05),transparent_34%),radial-gradient(circle_at_82%_8%,rgba(34,211,238,0.07),transparent_34%)]" />
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mx-auto mt-5 max-w-5xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
            ...
            <button
              onClick={onLoad ?? noop}
              className="h-10 rounded-2xl bg-red-500 px-7 text-sm font-black text-white shadow-[0_0_22px_rgba(239,68,68,0.22)] transition hover:bg-red-400"
            >
              Load Report
            </button>
          </div>
