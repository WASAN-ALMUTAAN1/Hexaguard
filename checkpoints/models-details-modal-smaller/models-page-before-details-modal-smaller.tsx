    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/75 px-4 py-8 backdrop-blur-xl">
      <section className="w-full max-w-2xl overflow-hidden rounded-[24px] border border-white/[0.08] bg-[#202323] shadow-[0_30px_100px_rgba(0,0,0,0.62)]">
        ...
        <footer className="flex flex-wrap justify-end gap-3 border-t border-white/[0.08] bg-[#27292a] px-6 py-4">
          ...
          <button type="button" onClick={onEdit} className="rounded-full border border-white/[0.08] px-5 py-3 text-sm font-black text-white transition hover:bg-white/[0.04]">
            Edit
          </button>
          <button type="button" onClick={onTest} className="rounded-full border border-[#4ad7ff]/35 px-5 py-3 text-sm font-black text-[#4ad7ff] transition hover:bg-[#4ad7ff]/10">
            Test Connection
          </button>
          <button type="button" onClick={onDefault} disabled={!isReadyForTesting(model)} className="rounded-full border border-emerald-400/25 px-5 py-3 text-sm font-black text-emerald-300 transition hover:bg-emerald-500/10 disabled:cursor-not-allowed disabled:opacity-40">
            Set Default
          </button>
          <button type="button" onClick={onToggle} className="rounded-full bg-[#ff3434] px-6 py-3 text-sm font-black text-white transition hover:bg-[#ff4545]">
      ...
      <section className="w-full max-w-2xl overflow-hidden rounded-[24px] border border-white/[0.08] bg-[#202323] shadow-[0_30px_100px_rgba(0,0,0,0.62)]">
        ...
        <footer className="flex flex-wrap justify-end gap-3 border-t border-white/[0.08] bg-[#27292a] px-6 py-4">
          ...
          {!isSuccess && !isAggregate && onEditConfiguration ? (
            <button type="button" onClick={onEditConfiguration} className="rounded-full bg-[#ff3434] px-6 py-3 text-sm font-black text-white transition hover:bg-[#ff4545]">
              Edit Configuration
            </button>
          ) : null}
        </footer>
  ...
  return (
    <main className="hxg-background min-h-screen px-4 py-6 text-white sm:px-6 xl:px-8">
        ...
        <section className="rounded-[23px] border border-white/[0.04] bg-[#27292a]/95 p-6">
          <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-black text-white">Model Registry</h2>
                        ...
                        <td className="relative px-4 py-3">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="h-8 rounded-[10px] border border-white/[0.08] bg-[#1f2122] px-3 text-xs font-black text-white transition hover:border-[#4ad7ff]/30"
                            >
                              View
                            </button>
                            ...
                            {model.status === "needs_setup" ? (
                              <button
                                ...
                                className="h-8 rounded-[10px] border border-amber-400/25 bg-amber-500/10 px-3 text-xs font-black text-amber-300 transition hover:bg-amber-500/15"
                              >
                                Configure
                              </button>
                            ) : model.status === "disabled" ? (
                              <button
                                ...
                                className="h-8 rounded-[10px] border border-emerald-400/25 bg-emerald-500/10 px-3 text-xs font-black text-emerald-300 transition hover:bg-emerald-500/15"
                              >
                                Enable
                              </button>
                            ) : (
                              <button
                                ...
                                className="h-8 rounded-[10px] border border-[#4ad7ff]/25 bg-[#4ad7ff]/10 px-3 text-xs font-black text-[#4ad7ff] transition hover:bg-[#4ad7ff]/15 disabled:cursor-not-allowed disabled:opacity-50"
                              >
                            ...
                            <div className="relative">
                              <button
                                ...
                                onClick={(event) => {
                                  ...
                                  setOpenMenuId(openMenuId === model.id ? null : model.id);
                                }}
                                className="h-8 rounded-[10px] border border-white/[0.08] bg-[#1f2122] px-3 text-xs font-black text-white transition hover:border-[#4ad7ff]/30"
                              >
                                ...
      ...
      {openMenuId && actionMenuPosition ? (() => {
        const menuModel = models.find((model) => model.id === openMenuId);
        ...
        return (
          <div
            ...
            className="fixed z-[140] w-48 overflow-hidden rounded-[14px] border border-white/[0.08] bg-[#1f2122] p-1 shadow-[0_24px_70px_rgba(0,0,0,0.55)]"
            style={{
          ...
          >
            ...
            <button
              type="button"
              onClick={() => {
                if (!isReadyForTesting(menuModel)) return;

                void setDefaultModel(menuModel);
                setOpenMenuId(null);
                setActionMenuPosition(null);
              }}
              disabled={!isReadyForTesting(menuModel)}
              className={`block w-full rounded-[10px] px-4 py-3 text-left text-xs font-black transition ${
                isReadyForTesting(menuModel)
                  ? "text-white hover:bg-white/[0.05]"
                  : "cursor-not-allowed text-[#727272]"
              }`}
            >
              Set Default
            </button>
            ...
            <button
              ...
              className="block w-full rounded-[10px] px-4 py-3 text-left text-xs font-black text-[#4ad7ff] transition hover:bg-[#4ad7ff]/10"
            >
              Test Connection
            </button>
            ...
            <button
              ...
              className="block w-full rounded-[10px] px-4 py-3 text-left text-xs font-black text-white transition hover:bg-white/[0.05]"
            >
              {menuModel.enabled ? "Disable" : "Enable"}
            </button>
            ...
            <button
              ...
              onClick={() => {
                const confirmed = window.confirm(
                  `Delete ${menuModel.displayName}? This will remove it from the active model registry.`
                );
              ...
              className="block w-full rounded-[10px] px-4 py-3 text-left text-xs font-black text-red-300 transition hover:bg-red-500/10"
            >
              Delete Model
            </button>
          </div>
