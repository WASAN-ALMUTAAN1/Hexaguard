...
<body>
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#080c0f] pb-16 text-gray-300 selection:bg-red-500/30">
      ...
      <div className="pointer-events-none fixed left-[-140px] top-[120px] z-0 h-[360px] w-[360px] rounded-full bg-red-500/5 blur-[90px]" />
  ...
  return (
    <header className="mb-8">
      <div className="relative overflow-hidden rounded-[30px] border border-white/8 bg-[#1f2122]/95 px-6 py-10 shadow-[0_20px_80px_rgba(0,0,0,0.32)] md:px-10 md:py-12">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(239,68,68,0.06)_0%,rgba(31,33,34,0.02)_26%,rgba(34,211,238,0.05)_100%)]" />
        <div className="pointer-events-none absolute -left-16 top-10 h-44 w-44 rounded-full bg-red-500/5 blur-[110px]" />
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <div className="mx-auto mt-8 max-w-5xl rounded-[26px] border border-white/8 bg-[#202326]/88 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] md:p-5">
            <div className="grid gap-3 md:grid-cols-[1fr_200px]">
              <input
                value={campaignIdInput ?? currentCampaignId}
                onChange={(e) => onCampaignIdInputChange?.(e.target.value)}
