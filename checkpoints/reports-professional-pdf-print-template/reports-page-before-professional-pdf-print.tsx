      ...
      <section className="relative z-10 mx-auto max-w-[1600px] space-y-8 px-6 pt-12 lg:px-10">
        ...
        {showReportsCatalogModal ? (
          <ReportsCatalogModal
            ...
            onPrint={(selectedCampaignId) => {
              setShowReportsCatalogModal(false);
              setCampaignIdInput(selectedCampaignId);
              Promise.resolve(loadReport(selectedCampaignId)).finally(() => {
...
function ReportsCatalogModal({
  ...
  onPrint: (campaignId: string) => void;
}) {
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-white/[0.08] bg-[#27292a] px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-sm text-[#a7a7a7]">
              Select a report to view it in the Reports page, or print it directly.
            </p>
          </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() => onPrint(report.campaignId)}
                            className="rounded-[12px] border border-white/[0.08] bg-[#1f2122] px-4 py-2 text-xs font-black text-white transition hover:border-red-400/40 hover:text-red-300"
                          >
                            Print
                          </button>
                        </div>
