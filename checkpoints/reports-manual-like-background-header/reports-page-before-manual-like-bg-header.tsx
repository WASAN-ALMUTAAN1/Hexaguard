...
function Header({
  ...
  return (
    <div className="relative isolate mx-auto w-full max-w-7xl">
      <div className="pointer-events-none absolute left-12 top-8 -z-10 h-72 w-72 rounded-full bg-red-500/4 blur-[140px]" />
      <div className="pointer-events-none absolute right-12 top-8 -z-10 h-72 w-72 rounded-full bg-cyan-500/8 blur-[140px]" />

      <header className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/78 px-8 py-8 text-center shadow-[0_22px_70px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_12%,rgba(239,68,68,0.06),transparent_36%),radial-gradient(circle_at_82%_8%,rgba(34,211,238,0.06),transparent_36%)]" />
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-3 text-3xl font-black uppercase leading-[0.95] tracking-[-0.05em] text-white md:text-5xl">
            AI Risk Analysis
            <span className="mt-1 block text-red-500">Reports</span>
          </h1>

          <p className="mx-auto mt-3 max-w-4xl text-sm leading-6 text-gray-300 md:text-base">
          ...
          <div className="mx-auto mt-5 max-w-5xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
            <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
              <input
                value={campaignIdInput ?? displayCampaignId}
                onChange={(event) => onCampaignIdInputChange?.(event.target.value)}
                placeholder="HXG-CMP-..."
                className="h-10 rounded-2xl border border-red-400/18 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/30"
              />

              <button
                onClick={onLoad ?? noop}
                disabled={loading}
                className="h-10 rounded-2xl bg-red-500 px-7 text-sm font-black text-white shadow-[0_0_22px_rgba(239,68,68,0.22)] transition hover:bg-red-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
...
function DetailBox({
  ...
  return (
    <section
      className={[
        "rounded-2xl border p-4",
        danger ? "border-red-400/25 bg-red-500/8" : "border-white/10 bg-black/25",
      ].join(" ")}
    >
...
function PriorityBadge({ priority }: { priority: Recommendation["priority"] }) {
  const colors: Record<string, string> = {
    Critical: "border-red-400/25 bg-red-500/8 text-red-300",
