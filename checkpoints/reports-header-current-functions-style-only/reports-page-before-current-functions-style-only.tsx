  ...
  return (
    <>
      <header className="relative mx-auto max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/75 px-8 py-12 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
        ...
        <div className="pointer-events-none absolute -left-28 top-0 h-64 w-64 rounded-full bg-red-500/16 blur-3xl" />
        <div className="pointer-events-none absolute -right-28 top-10 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl" />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_0%,rgba(239,68,68,0.16),transparent_34%),radial-gradient(circle_at_82%_0%,rgba(34,211,238,0.10),transparent_32%)]" />
      ...
      <section className="relative mx-auto mt-6 max-w-[1320px] overflow-hidden rounded-[24px] border border-white/10 bg-[#202323]/75 p-4 shadow-[0_18px_55px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
        <div className="pointer-events-none absolute inset-0 opacity-[0.08] [background-image:linear-gradient(rgba(255,255,255,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:42px_42px]" />
        ...
        <div className="relative mt-3 grid grid-cols-2 gap-2 sm:grid-cols-5">
        ...
        <div className="relative mt-3 flex flex-wrap gap-2 text-[11px] font-mono text-gray-500">
          <span className="rounded-full border border-white/10 bg-black/25 px-3 py-1.5">
            Campaign: <span className="text-cyan-200">{displayCampaignId}</span>
          </span>

          <span className="rounded-full border border-white/10 bg-black/25 px-3 py-1.5">
            Status: <span className="text-emerald-300">{displayStatus}</span>
          </span>

          <span className="rounded-full border border-white/10 bg-black/25 px-3 py-1.5">
            Readiness: <span className="text-amber-300">{displayReadiness}</span>
          </span>
        </div>
      </section>
    </>
