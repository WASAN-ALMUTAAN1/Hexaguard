...
function Header({
  ...
  return (
    <div className="relative isolate mx-auto w-full max-w-7xl">
      <div className="pointer-events-none absolute left-12 top-8 -z-10 h-72 w-72 rounded-full bg-red-500/8 blur-[140px]" />
      <div className="pointer-events-none absolute right-12 top-8 -z-10 h-72 w-72 rounded-full bg-cyan-500/8 blur-[140px]" />

      <header className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/82 px-8 py-8 text-center shadow-[0_22px_70px_rgba(0,0,0,0.32)] backdrop-blur-2xl">
          ...
          <div className="mx-auto mt-5 max-w-5xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
            <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
              <input
                ...
                placeholder="HXG-CMP-..."
                className="h-10 rounded-2xl border border-red-400/20 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/45"
              />
...
function RiskBadge({ level, score }: { level: RiskLevel; score: number }) {
  const styles: Record<string, string> = {
    Critical: "border-red-300/40 bg-red-500 text-white shadow-[0_0_18px_rgba(239,68,68,0.07)]",
