...
function Header({
  ...
  return (
    <header className="relative mx-auto w-full max-w-[1320px] overflow-hidden rounded-[28px] border border-white/10 bg-[#202323]/74 px-8 py-10 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] backdrop-blur-2xl">
      <div className="pointer-events-none absolute inset-0 opacity-[0.13] [background-image:linear-gradient(rgba(255,255,255,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:46px_46px]" />
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_0%,rgba(239,68,68,0.055),transparent_34%),radial-gradient(circle_at_82%_0%,rgba(34,211,238,0.06),transparent_34%)]" />
        ...
        <div className="mx-auto mt-6 max-w-5xl rounded-[22px] border border-white/10 bg-black/25 p-3 backdrop-blur-xl">
          <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
            <input
              ...
              placeholder="HXG-CMP-..."
              className="h-11 rounded-2xl border border-red-400/18 bg-black/35 px-5 font-mono text-sm text-white outline-none transition placeholder:text-gray-500 focus:border-red-400/30"
            />

            <button
              onClick={onLoad ?? noop}
              disabled={loading}
              className="h-11 rounded-2xl bg-red-500 px-7 text-sm font-black text-white shadow-[0_0_22px_rgba(239,68,68,0.22)] transition hover:bg-red-400 disabled:cursor-not-allowed disabled:opacity-60"
            >
